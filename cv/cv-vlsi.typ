...
- Courses: #(data.courses.ee.vlsi, data.courses.ee.ic, data.courses.ee.hwdesign, data.courses.ee.comparch, "Electronics I & II", data.courses.ee.dsp, data.courses.ee.signals, data.courses.ee.circuits, data.courses.ee.emag, data.courses.ee.stochastic, data.courses.ee.logic).join(", ")
]
